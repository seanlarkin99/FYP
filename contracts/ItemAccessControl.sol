...
contract ItemAccessControl is Ownable{
    ...
    address[5] public MinecraftExecutiveAddresses = [ceoAddress];//set it initally as CEO address?
    ...
    function addNewMinecraftExecutive(address _newMinecraftExecutive) external onlyMinecraftExecutive{
    ...
    function removeMinecraftExecutive(address _minecraftExecToBeRemoved) external onlyMinecraftExecutive{
    ...
    function setMinecraftCEO(address _newMinecraftCEO) external onlyMinecraftCEO{
